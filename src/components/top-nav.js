...
import {generateAuralUpdate, restartGame} from '../actions'; // use dispatch on event handlers, like click. When we use event listeners we don't require mapStateToProps function. 
                                                            // we require mapStateToProps function in stateless Components generally
import './top-nav.css';
